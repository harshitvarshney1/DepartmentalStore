...
namespace DepartmentalStore
{
    public class AddOperations
    {
       ...
       public static void AddProductOrder()
        {
            var po1 = new PurchaseOrder {  ProductId = 1, SupplierId = 1, OrderDate = new DateTime(2015, 12, 21, 5, 10, 20), QuantityNeeded = 10, amount = 1000 };
            var po2 = new PurchaseOrder { ProductId = 2, SupplierId = 2, OrderDate = new DateTime(1999, 01, 11,1,2,3), QuantityNeeded = 4, amount = 2000 };
            var po3 = new PurchaseOrder {  ProductId = 3, SupplierId = 3, OrderDate = new DateTime(2022, 10, 12,5,23,22), QuantityNeeded = 2, amount = 25000 };
            var po4 = new PurchaseOrder {  ProductId = 4, SupplierId = 4, OrderDate = new DateTime(2015, 02, 22,5,23,12), QuantityNeeded = 12, amount = 30000 };
            var po5 = new PurchaseOrder {  ProductId = 5, SupplierId = 4, OrderDate = new DateTime(1992, 12, 01,7,8,3), QuantityNeeded = 25, amount = 1200000 };
            context.AddRange(po1, po2, po3, po4,po5);           
                context.SaveChanges();
